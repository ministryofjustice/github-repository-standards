class GithubRepositoryStandards
  ...
  describe GithubGraphQlClient do
    before {
      allow_any_instance_of(GithubRepositoryStandards::GithubGraphQlClient).to receive(:sleep)
    }
    ...
    context "test GithubGraphQlClient" do
      ...
      context "when env var is missing" do
        ...
        it "call run_query and catch error" do
          expect { GithubRepositoryStandards::GithubGraphQlClient.new }.to raise_error(KeyError)
        end
      end
